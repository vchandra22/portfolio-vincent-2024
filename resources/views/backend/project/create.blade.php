...
@section('content')
    ...
    <section class="p-5 min-h-screen md:ml-64 bg-black">
        ...
        <form action="{{ route('backend.store_project') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="space-y-6">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="short_description" id="short_description"
                        class="bg-black border border-accent text-accent text-sm focus:ring-accent focus:border-accent block w-full p-2.5"
                        placeholder="Describe your project in short" value="{{ old('short_description') }}" required
                        autofocus />
